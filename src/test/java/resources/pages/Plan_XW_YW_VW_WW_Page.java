...
public class Plan_XW_YW_VW_WW_Page extends Plan_OW_Page{
    ...
    public void ClickAndVerify_YW() {
        assertThat(YourPlanXW.getText(), equalTo("AARP Medicare Supplement Rider 2 YW"));
        clickAndVerify();
    }
    public void ClickAndVerify_VW() {
        assertThat(YourPlanXW.getText(), equalTo("AARP Medicare Supplement Rider 3 VW"));
        clickAndVerify();
    }
    public void ClickAndVerify_WW() {
        assertThat(YourPlanXW.getText(), equalTo("AARP Medicare Supplement Rider 4 WW"));
        clickAndVerify();
    }
